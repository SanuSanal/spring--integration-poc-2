...
public class UcicIdFetchModel {
	...
	public UcicIdFetchModel(String mpNo, String fdglCode, String empName, String emailId, String designation,
			String customerName, String customerDob, String customerMobileNo, String customerIdNo) {
		this.mpNo = mpNo;
		this.fdglCode = fdglCode;
		this.empName = empName;
		this.emailId = emailId;
